...
def process_tokens_2(toks):
    ...
    for t, pos in pos_tokens:
        ...
        t = lemmatizer.lemmatize(t, get_wordnet_pos(pos))
...
def process_tokens_3(toks):
    ...
    # generate bigrams and append them
    bigrams = ['_'.join(bigram) for bigram in ngrams(filtered_tokens, 2)]
    new_toks = filtered_tokens + bigrams
